            ...
            <TextSection>
                ...
                <div className="prose prose-lg prose-indigo max-w-4xl mx-auto mt-6 text-gray-500">
                    <p className="text-justify py-4">
                        This website privacy policy (“Privacy Policy” or “Policy”) describe <Link className="text-accent" href="https://gappblocks.com">https://gappblocks.com</Link> (Link to our main website) (herein after referred to as “GAPP Blocks”, “Site” or “Website”) policy on the collection, use, and disclosure of information about you in connection with your use of the domain, <Link className="text-accent" href="https://gappblocks.com">https://gappblocks.com</Link> (Link to our main website) and all associated product sites listed on our Site. The terms “we”, “us” or “our”, refer to <Link className="text-accent" href="https://gappblocks.com">https://gappblocks.com</Link>. (Link to our main website) When you use the service available at our Website, you consent to our collection, use, and disclosure of information about you as described in this Privacy Policy. The Site is owned and controlled by <Link className="text-accent" href="www.gapp.co">GAPP Company</Link>, 16192 Coastal Highway, Lewes, DE 19958. 
                    </p>
                    ...
                    <p className="text-justify">
                        8.1 We want to help you guard your children&#39;s privacy. We encourage you to talk to your children (below 18 years) about safe and responsible use of their Personal Information while using our Site. The Site does not publish content that is harmful, derogatory or pornographic in nature. However, the Website shall not incur any liability should your children provide us any Personal Information without parental consent. If you become aware that a child has provided us with personal information without parental consent, please contact us at ${<Link className="text-accent" href="mailto:legal@gappblocks.com">legal@gappblocks.com</Link>}. If we become aware that a child under 18 has provided us with Personal Information without parental consent, we take steps to remove such information and terminate the child&#39;s account.
                    </p>
                    ...
                    <p className="text-justify">
                        14.1 By using the Website, you consent to the terms of our Privacy Policy and to the Site&#39;s processing of Personal Information for the purposes given above as well as those explained where we at <Link className="text-accent" href="https://gappblocks.com">https://gappblocks.com</Link> collect personal information on the web.
                    </p>
                    <p className="text-justify">
                        10.2 Cookies: When you visit our Site, we may place “cookies” on your computer to recognize you. We do this to store your preferences, collect statistical data and track your use of our service. Cookies are widely used, and most web browsers are configured initially to accept cookies automatically. If you prefer not to accept cookies, you may adjust and configure your browser settings accordingly. However, if you turn off cookies, or refuse to accept a request to place a cookie, some features and services on the Site may not function properly. Ad companies (including but not limited to Google and Facebook) may also place cookies on your computer to track your activities across various sites so that they can display targeted advertisements. In addition to above you are requested to read our cookie policy at <Link className="text-accent" href="https://gappblocks.com/privacy-policy/">https://gappblocks.com/privacy-policy/</Link>
                    </p>
